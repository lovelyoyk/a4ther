...
#  A4ther Systems · Coletor ativo (ADB Wi-Fi) · v4.4.91
#
...
EOF
  printf '%s\n' "${NC}${DIM}  Auditoria de integridade · Free Fire · v4.4.91${NC}"
  hr
}
...
build_master() {
...

  {
    ...
    echo " Gerado por a4ther v4.4.91 (coletor ADB Wi-Fi)"
    ...
    echo ""
    echo "============================================================"
    echo " FIM DO RELATORIO - A4ther v4.4.91"
    echo "============================================================"
  } > "$stage" 2>/dev/null
