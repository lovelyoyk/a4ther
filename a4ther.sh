#!/system/bin/sh
# ============================================================
#  A4ther Systems v4.4.82 | LS Aluguel
...
if [ "$_IS_ROOT" = "1" ]; then
    ...
    # v4.4.82: instruções verbosas de pareamento WiFi REMOVIDAS (o usuário já
...
SIGS
    ...
    # v4.4.82: ESCOPO RESTRITO — só Download + Android/data + Android/obb, e só
...
# v4.4.82: checagem direta do diretório de CAs de usuário (Mitmproxy/Burp/injeção).
...
# ============================================================
#  v4.4.82: análise profunda movida pro verificador web (BugReport nativo).
