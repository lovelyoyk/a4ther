#!/system/bin/sh
# ============================================================
#  A4ther Systems v4.4.81 | LS Aluguel
...
if [ "$_IS_ROOT" = "1" ]; then
    ...
    # v4.4.81: instruções verbosas de pareamento WiFi REMOVIDAS (o usuário já
...
SIGS
    ...
    # v4.4.81: ESCOPO RESTRITO — só Download + Android/data + Android/obb, e só
...
# v4.4.81: checagem direta do diretório de CAs de usuário (Mitmproxy/Burp/injeção).
...
# ============================================================
#  v4.4.81: análise profunda movida pro verificador web (BugReport nativo).
